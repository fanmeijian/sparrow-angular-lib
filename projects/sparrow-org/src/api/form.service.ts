...
export class FormService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createFormDataIndex(formDataId: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public createFormDataIndex(formDataId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public createFormDataIndex(formDataId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public createFormDataIndex(formDataId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (formDataId === null || formDataId === undefined) {
            throw new Error('Required parameter formDataId was null or undefined when calling createFormDataIndex.');
        }
