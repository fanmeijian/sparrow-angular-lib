...
export class ForumService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public topicCommentFilter(body: Array<SparrowJpaFilter>, topicId: string, page?: number, size?: number, sort?: Array<string>, observe?: 'body', reportProgress?: boolean): Observable<PageTopicComment>;
    public topicCommentFilter(body: Array<SparrowJpaFilter>, topicId: string, page?: number, size?: number, sort?: Array<string>, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageTopicComment>>;
    public topicCommentFilter(body: Array<SparrowJpaFilter>, topicId: string, page?: number, size?: number, sort?: Array<string>, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageTopicComment>>;
    public topicCommentFilter(body: Array<SparrowJpaFilter>, topicId: string, page?: number, size?: number, sort?: Array<string>, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
