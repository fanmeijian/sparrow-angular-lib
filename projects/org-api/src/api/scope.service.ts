...
export class ScopeService {
     ...
     */
    public addScopePermissions(body: Array<string>, type: string, scopeId: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public addScopePermissions(body: Array<string>, type: string, scopeId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public addScopePermissions(body: Array<string>, type: string, scopeId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public addScopePermissions(body: Array<string>, type: string, scopeId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (type === null || type === undefined) {
            throw new Error('Required parameter type was null or undefined when calling addScopePermissions.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public removeScopePermissions(body: Array<string>, type: string, scopeId: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public removeScopePermissions(body: Array<string>, type: string, scopeId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public removeScopePermissions(body: Array<string>, type: string, scopeId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public removeScopePermissions(body: Array<string>, type: string, scopeId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (type === null || type === undefined) {
            throw new Error('Required parameter type was null or undefined when calling removeScopePermissions.');
        }
