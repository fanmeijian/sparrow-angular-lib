...
export const APIS = [AuditlogService, CommentService, DataOrganizationService, DataPermissionService, DatamodelService, DictService, EmployeeService, FeedbackService, FileService, FormService, GroupService, JoblevelService, MenuService, NoticeService, OrganizationService, PageElementService, PemgroupService, ReportService, RestApiServiceService, RoleService, RuleService, ScheduleService, ScopeService, SysconfigService, SysroleService, UserService];
