...
export class JoblevelService {
     ...
     */
    public addLevelParent(body: Array<OrganizationPositionLevelId>, organizationId?: string, positionLevelId?: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public addLevelParent(body: Array<OrganizationPositionLevelId>, organizationId?: string, positionLevelId?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public addLevelParent(body: Array<OrganizationPositionLevelId>, organizationId?: string, positionLevelId?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public addLevelParent(body: Array<OrganizationPositionLevelId>, organizationId?: string, positionLevelId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public removeLevelParent(body: Array<OrganizationPositionLevelId>, organizationId?: string, positionLevelId?: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public removeLevelParent(body: Array<OrganizationPositionLevelId>, organizationId?: string, positionLevelId?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public removeLevelParent(body: Array<OrganizationPositionLevelId>, organizationId?: string, positionLevelId?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public removeLevelParent(body: Array<OrganizationPositionLevelId>, organizationId?: string, positionLevelId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
