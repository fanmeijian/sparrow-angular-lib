...
export interface HistoricDecisionInstanceDto { 
    ...
    /**
     * The time the instance was evaluated.  [Default format](https://docs.camunda.org/manual/7.19/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     */
    evaluationTime?: Date;
    /**
